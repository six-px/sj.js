...
import { getObjProperty } from './objectProperty'; // 内部方法

function _getValue(obj, tree) {
  var value = obj; // 如果是对象树

  if (tree) {
    var property = getObjProperty(obj, tree);
...
function _checkDateTime(value) {
  ...
  if ([undefined, null, "", " ", 0].includes(value) || typeof value === "object") {
    return false;
  }
...
export function getDateTime(obj) {
